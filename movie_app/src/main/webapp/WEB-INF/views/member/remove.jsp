...
<div class="tit-mycgv">
    <h3 style="text-align: center; padding-left: 346px">비밀번호 확인</h3>
</div>


<p class="info-com">고객님의 개인정보 보호를 위한 절차이오니, CGV 로그인 시 사용하는 비밀번호를 입력해 주세요.</p>
<form id="form1" method="post" action="/member/remove">
        ...
        <div class="info-confirm">
            <p>
                ...
                <p>
                    ...
                    <input type="password" id="pwd" name="pwd" title="비밀번호" data-title="비밀번호를 " data-message="정상적으로 입력해 주세요." required="required" maxlength="20" class="small">
                </p>
        </div>
    </fieldset>
    <div class="set-btn">
        <button type="submit" id="save" class="round inred on"><span>확인</span></button> 
        <a href="/" class="round gray"><span>OGV 첫화면으로</span></a>
    </div>
</form>

<form name="targetform" id="targetform" method="post" action="https://www.cgv.co.kr/user/mycgv/myinfo/confirm-password-proc.aspx" novalidate="novalidate">
	<input type="hidden" name="password" id="password">
	<input type="hidden" name="returnURL" id="returnURL" value="/user/mycgv/myinfo/leave-cjone.aspx">
</form>
