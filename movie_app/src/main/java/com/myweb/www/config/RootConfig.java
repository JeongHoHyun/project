...
public class RootConfig {
	...
	public DataSource dataSources() {
		...
		hikariConfig.setJdbcUrl("jdbc:log4jdbc:mysql://localhost:3306/cgv_db?serverTimezone=Asia/Seoul");
		hikariConfig.setUsername("cgvuser");
		hikariConfig.setPassword("Mysql@1234");
	...
	public SqlSessionFactory sqlSessionFactory() throws Exception {
		...
		sqlFactoryBean.setDataSource(dataSources());
